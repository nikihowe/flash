...
//=========  (Wed Jul 15 10:06:45 2015) by ROOT version6.04/00
   ...
   TH1F *Graph_Graph11 = new TH1F("Graph_Graph11","Event number: 2",100,0,1200);
   ...
   Graph_Graph11->GetXaxis()->SetTitle("z flash data");
   Graph_Graph11->GetXaxis()->SetLabelFont(42);
   Graph_Graph11->GetXaxis()->SetLabelSize(0.035);
   Graph_Graph11->GetXaxis()->SetTitleSize(0.035);
   Graph_Graph11->GetXaxis()->SetTitleFont(42);
   Graph_Graph11->GetYaxis()->SetTitle("y flash data");
   ...
   TH1F *Graph_Graph_Graph1112 = new TH1F("Graph_Graph_Graph1112","Event number: 2",100,0,1200);
   ...
   Graph_Graph_Graph1112->GetXaxis()->SetTitle("z flash data");
   ...
   Graph_Graph_Graph1112->GetYaxis()->SetTitle("y flash data");
