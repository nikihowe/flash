...
//=========  (Wed Jul 15 12:53:51 2015) by ROOT version6.04/00
   ...
   TH1F *Graph_Graph16 = new TH1F("Graph_Graph16","Event 3",100,0,1200);
   ...
   Graph_Graph16->GetXaxis()->SetTitle("Z [cm]");
   ...
   Graph_Graph16->GetYaxis()->SetTitle("Y [cm]");
   ...
   TH1F *Graph_Graph_Graph1617 = new TH1F("Graph_Graph_Graph1617","Event 3",100,0,1200);
   ...
   Graph_Graph_Graph1617->GetXaxis()->SetTitle("Z [cm]");
   ...
   Graph_Graph_Graph1617->GetYaxis()->SetTitle("Y [cm]");
