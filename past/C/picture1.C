...
//=========  (Wed Jul 15 12:53:51 2015) by ROOT version6.04/00
   ...
   TH1F *Graph_Graph6 = new TH1F("Graph_Graph6","Event 1",100,0,1200);
   ...
   Graph_Graph6->GetXaxis()->SetTitle("Z [cm]");
   Graph_Graph6->GetXaxis()->SetLabelFont(42);
   Graph_Graph6->GetXaxis()->SetLabelSize(0.035);
   Graph_Graph6->GetXaxis()->SetTitleSize(0.035);
   Graph_Graph6->GetXaxis()->SetTitleFont(42);
   Graph_Graph6->GetYaxis()->SetTitle("Y [cm]");
   ...
   TH1F *Graph_Graph_Graph67 = new TH1F("Graph_Graph_Graph67","Event 1",100,0,1200);
   ...
   Graph_Graph_Graph67->GetXaxis()->SetTitle("Z [cm]");
   ...
   Graph_Graph_Graph67->GetYaxis()->SetTitle("Y [cm]");
