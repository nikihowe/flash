...
//=========  (Wed Jul 15 12:53:51 2015) by ROOT version6.04/00
   ...
   TH1F *Graph_Graph31 = new TH1F("Graph_Graph31","Event 6",100,0,1200);
   ...
   Graph_Graph31->GetXaxis()->SetTitle("Z [cm]");
   ...
   Graph_Graph31->GetYaxis()->SetTitle("Y [cm]");
   ...
   TH1F *Graph_Graph_Graph3132 = new TH1F("Graph_Graph_Graph3132","Event 6",100,0,1200);
   ...
   Graph_Graph_Graph3132->GetXaxis()->SetTitle("Z [cm]");
   ...
   Graph_Graph_Graph3132->GetYaxis()->SetTitle("Y [cm]");
   ...
   pt->SetFillStyle(0);
   pt->SetTextFont(42);
   TText *AText = pt->AddText("Event 6");
   pt->Draw();
   c->Modified();
   c->cd();
   c->SetSelected(c);
