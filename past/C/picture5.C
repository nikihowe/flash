...
//=========  (Wed Jul 15 12:53:51 2015) by ROOT version6.04/00
   ...
   TH1F *Graph_Graph26 = new TH1F("Graph_Graph26","Event 5",100,0,1200);
   ...
   Graph_Graph26->GetXaxis()->SetTitle("Z [cm]");
   ...
   Graph_Graph26->GetYaxis()->SetTitle("Y [cm]");
   ...
   TH1F *Graph_Graph_Graph2627 = new TH1F("Graph_Graph_Graph2627","Event 5",100,0,1200);
   ...
   Graph_Graph_Graph2627->GetXaxis()->SetTitle("Z [cm]");
   ...
   Graph_Graph_Graph2627->GetYaxis()->SetTitle("Y [cm]");
   ...
   pt->SetFillStyle(0);
   pt->SetTextFont(42);
   TText *AText = pt->AddText("Event 5");
   pt->Draw();
   c->Modified();
   c->cd();
   c->SetSelected(c);
