...
//=========  (Wed Jul 15 10:06:45 2015) by ROOT version6.04/00
   ...
   TH1F *Graph_Graph1 = new TH1F("Graph_Graph1","Event number: 0",100,0,1200);
   ...
   TH1F *Graph_Graph_Graph12 = new TH1F("Graph_Graph_Graph12","Event number: 0",100,0,1200);
   ...
   Graph_Graph_Graph12->GetXaxis()->SetTitle("z flash data");
   ...
   Graph_Graph_Graph12->GetYaxis()->SetTitle("y flash data");
