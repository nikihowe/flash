...
//=========  (Wed Jul 15 12:53:51 2015) by ROOT version6.04/00
   ...
   TH1F *Graph_Graph21 = new TH1F("Graph_Graph21","Event 4",100,0,1200);
   ...
   Graph_Graph21->GetXaxis()->SetTitle("Z [cm]");
   ...
   Graph_Graph21->GetYaxis()->SetTitle("Y [cm]");
   ...
   TH1F *Graph_Graph_Graph2122 = new TH1F("Graph_Graph_Graph2122","Event 4",100,0,1200);
   ...
   Graph_Graph_Graph2122->GetXaxis()->SetTitle("Z [cm]");
   ...
   Graph_Graph_Graph2122->GetYaxis()->SetTitle("Y [cm]");
