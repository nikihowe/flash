...
//=========  (Wed Jul 15 12:53:51 2015) by ROOT version6.04/00
   ...
   TH1F *Graph_Graph36 = new TH1F("Graph_Graph36","Event 7",100,0,1200);
   ...
   Graph_Graph36->GetXaxis()->SetTitle("Z [cm]");
   ...
   Graph_Graph36->GetYaxis()->SetTitle("Y [cm]");
   ...
   TH1F *Graph_Graph_Graph3637 = new TH1F("Graph_Graph_Graph3637","Event 7",100,0,1200);
   ...
   Graph_Graph_Graph3637->GetXaxis()->SetTitle("Z [cm]");
   ...
   Graph_Graph_Graph3637->GetYaxis()->SetTitle("Y [cm]");
   ...
   pt->SetFillStyle(0);
   pt->SetTextFont(42);
   TText *AText = pt->AddText("Event 7");
   pt->Draw();
   c->Modified();
   c->cd();
   c->SetSelected(c);
