...
# For specified cut values, loops over the cut values and fills a histogram
# with the npe-position-weighted distance between flash_z and mc_start_z
...
#    fout.write("\n")
    ...
    print "for X = " + str(5) + ":"
    print str(fit.GetParameter(1))
    print str(fit.GetParameter(2))
