void STD and Efficiency()
{
//=========Macro generated from canvas: c/
//=========  (Wed Jul 15 10:13:32 2015) by ROOT version6.04/00
   ...
   graph->SetName("");
   graph->SetTitle("Gaus fit STD and Efficiency wrt cut value; Cut Value (npe); STD (npe-weighted) (Blue) / Efficiency (Red)");
   ...
   Graph_Graph1->GetYaxis()->SetTitle(" STD (npe-weighted) (Blue) / Efficiency (Red)");
